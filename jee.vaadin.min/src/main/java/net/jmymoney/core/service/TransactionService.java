...
public class TransactionService {
    ...
    public Transaction update(Transaction transaction) {
    	...
    	List<TransactionSplit> unusedSplits = originalTransaction.getSplits().stream().filter(orig -> !transaction.getSplits().stream().anyMatch(split -> orig.getId().equals(split.getId()))).collect(Collectors.toList());
