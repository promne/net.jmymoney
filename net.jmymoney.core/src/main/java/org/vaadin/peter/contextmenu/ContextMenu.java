...
public class ContextMenu extends AbstractExtension {
    ...
    private final ContextMenuServerRpc serverRPC = new ContextMenuServerRpc() {
        ...
        public void onContextMenuOpenRequested(int x, int y, String connectorId) {
            fireEvent(new ContextMenuOpenedOnComponentEvent(ContextMenu.this, x, y, (Component) UI.getCurrent()
                    .getConnectorTracker().getConnector(connectorId)));
        }
    ...
    public void setAsGridContextMenu(final Grid grid) {
        extend(grid);
        ...
        grid.addItemClickListener(new ItemClickEvent.ItemClickListener() {
            ...
            public void itemClick(ItemClickEvent event) {
                if (event.getButton() == MouseButton.RIGHT) {
                    fireEvent(new ContextMenuOpenedOnGridRowEvent(ContextMenu.this, grid, event.getItemId(), event
                            .getPropertyId()));
    ...
    public void setAsTableContextMenu(final Table table) {
        ...
        table.addItemClickListener(new ItemClickEvent.ItemClickListener() {
            ...
            public void itemClick(ItemClickEvent event) {
                if (event.getButton() == MouseButton.RIGHT) {
                    fireEvent(new ContextMenuOpenedOnTableRowEvent(ContextMenu.this, table, event.getItemId(), event
                            .getPropertyId()));
                    open(event.getClientX(), event.getClientY());
                }
            }
        ...
        table.addHeaderClickListener(new HeaderClickListener() {
            ...
            public void headerClick(HeaderClickEvent event) {
                if (event.getButton() == MouseButton.RIGHT) {
                    fireEvent(new ContextMenuOpenedOnTableHeaderEvent(ContextMenu.this, table, event.getPropertyId()));
                    open(event.getClientX(), event.getClientY());
                }
            }
        });
    ...
    public void setAsTreeContextMenu(final Tree tree) {
        ...
        tree.addItemClickListener(new ItemClickListener() {
            ...
            public void itemClick(ItemClickEvent event) {
                if (event.getButton() == MouseButton.RIGHT) {
                    fireEvent(new ContextMenuOpenedOnTreeItemEvent(ContextMenu.this, tree, event.getItemId()));
                    open(event.getClientX(), event.getClientY());
                }
            }
        });
    ...
    public void open(Component component) {
        getRpcProxy(ContextMenuClientRpc.class).showContextMenuRelativeTo(component.getConnectorId());
    }
    ...
    public void addContextMenuTableListener(ContextMenu.ContextMenuOpenedListener.TableListener contextMenuTableListener) {
        addListener(ContextMenuOpenedOnTableRowEvent.class, contextMenuTableListener,
                ContextMenuOpenedListener.TableListener.MENU_OPENED_FROM_TABLE_ROW_METHOD);
        addListener(ContextMenuOpenedOnTableHeaderEvent.class, contextMenuTableListener,
                ContextMenuOpenedListener.TableListener.MENU_OPENED_FROM_TABLE_HEADER_METHOD);
        addListener(ContextMenuOpenedOnTableFooterEvent.class, contextMenuTableListener,
    ...
    public void addContextMenuTreeListener(ContextMenu.ContextMenuOpenedListener.TreeListener contextMenuTreeListener) {
        addListener(ContextMenuOpenedOnTreeItemEvent.class, contextMenuTreeListener,
    ...
    public void addContextMenuComponentListener(
        ...
        addListener(ContextMenuOpenedOnComponentEvent.class, contextMenuComponentListener,
    ...
    public class ContextMenuItem implements Serializable {
         ...
         */
        public ContextMenuItem addItem(String caption) {
            ContextMenuItemState childItemState = state.addChild(caption, getNextId());
    ...
    public interface ContextMenuItemClickListener extends EventListener {
        ...
        public static final Method ITEM_CLICK_METHOD = ReflectTools.findMethod(ContextMenuItemClickListener.class,
                "contextMenuItemClicked", ContextMenuItemClickEvent.class);
    ...
    public interface ContextMenuClosedListener extends EventListener {
        public static final Method MENU_CLOSED = ReflectTools.findMethod(ContextMenuClosedListener.class,
                "onContextMenuClosed", ContextMenuClosedEvent.class);
    ...
    public interface ContextMenuOpenedListener extends EventListener {
        ...
        public interface ComponentListener extends ContextMenuOpenedListener {
            ...
            public static final Method MENU_OPENED_FROM_COMPONENT = ReflectTools.findMethod(
                    ContextMenuOpenedListener.ComponentListener.class, "onContextMenuOpenFromComponent",
        ...
        public interface TableListener extends ContextMenuOpenedListener {
            ...
            public static final Method MENU_OPENED_FROM_TABLE_ROW_METHOD = ReflectTools.findMethod(
                    ContextMenuOpenedListener.TableListener.class, "onContextMenuOpenFromRow",
            ...
            public static final Method MENU_OPENED_FROM_TABLE_HEADER_METHOD = ReflectTools.findMethod(
                    ContextMenuOpenedListener.TableListener.class, "onContextMenuOpenFromHeader",
            ...
            public static final Method MENU_OPENED_FROM_TABLE_FOOTER_METHOD = ReflectTools.findMethod(
                    ContextMenuOpenedListener.TableListener.class, "onContextMenuOpenFromFooter",
        ...
        public interface TreeListener extends ContextMenuOpenedListener {
            public static final Method MENU_OPENED_FROM_TREE_ITEM_METHOD = ReflectTools.findMethod(
                    ContextMenuOpenedListener.TreeListener.class, "onContextMenuOpenFromTreeItem",
    ...
    public static class ContextMenuOpenedOnTreeItemEvent extends EventObject {
        ...
        public ContextMenuOpenedOnTreeItemEvent(ContextMenu contextMenu, Tree tree, Object itemId) {
            super(tree);
    ...
    public static class ContextMenuOpenedOnTableHeaderEvent extends EventObject {
        ...
        public ContextMenuOpenedOnTableHeaderEvent(ContextMenu contextMenu, Table source, Object propertyId) {
            super(source);
    ...
    public static class ContextMenuOpenedOnTableFooterEvent extends EventObject {
        ...
        public ContextMenuOpenedOnTableFooterEvent(ContextMenu contextMenu, Table source, Object propertyId) {
            super(source);
    ...
    public static class ContextMenuOpenedOnTableRowEvent extends EventObject {
        ...
        public ContextMenuOpenedOnTableRowEvent(ContextMenu contextMenu, Table table, Object itemId, Object propertyId) {
            super(table);
    ...
    public static class ContextMenuOpenedOnGridRowEvent extends EventObject {
        private static final long serialVersionUID = -470218301318358912L;
        ...
        public ContextMenuOpenedOnGridRowEvent(ContextMenu contextMenu, Grid grid, Object itemId, Object propertyId) {
            super(grid);
    ...
    public static class ContextMenuOpenedOnComponentEvent extends EventObject {
        ...
        public ContextMenuOpenedOnComponentEvent(ContextMenu contextMenu, int x, int y, Component component) {
            super(component);
